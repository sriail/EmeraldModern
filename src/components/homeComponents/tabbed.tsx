  ...
  return (
    <div className="flex flex-col w-full h-screen overflow-hidden bg-background/95 backdrop-blur-sm">
      ...
      : ""
         ...
         sandbox={settingsStore.proxy === "scramjet" 
         ? "allow-same-origin allow-scripts allow-forms allow-presentation allow-top-navigation-by-user-activation allow-pointer-lock"
